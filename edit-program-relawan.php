...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <main>
                ...
                <div class="mt-2 regis-title"><h3>Edit Program Relawan</h3></div>    
                ...
                <div class="form-group label-txt">
                        ...
                        <div class="form-group mt-4 mb-3">
                            ...
                            <input type="text" id="tb_penanggung_jawab" name="tb_penanggung_jawab" class="form-control" 
                            value="<?= $programRelawan["penanggung_jawab"]; ?>">
                        </div>
                        ...
                        <label for="tb_tenggat_waktu" class="label-txt">Tenggat Waktu Pengumpulan Relawan</label>
                            <input type="date" id="tb_tenggat_waktu" name="tb_tenggat_waktu" class="form-control" 
                            value="<?= $programRelawan["tenggat_waktu"]; ?>">
                        </div>
                            ...
                            <div class="form-group mb-5 ">
                                <label for="status_program_donasi" class="font-weight-bold" ><span class="label-form-span">Status Program</span></label><br>
                                    ...
                                    <div class="radio-wrapper mt-1 bg-white">
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="status_program_relawan" name="status_program_relawan" 
                                            class="form-check-input" value="Berjalan" <?php if($programRelawan['status_program_relawan']=='Berjalan') echo 'checked'?>>
                                    ...
                                    <div class="radio-wrapper mt-1 bg-white">
                                        <div class="form-check form-check-inline">
                                            <input type="radio" id="status_program_relawan" name="status_program_relawan" 
                                            class="form-check-input" value="Siap dilaksanakan" <?php if($programRelawan['status_program_relawan']=='Siap dilaksanakan') echo 'checked'?>>
